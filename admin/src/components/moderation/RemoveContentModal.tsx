...
interface RemoveContentModalProps {
  onClose?: () => void;
  onProceed?: (data: { removalReason: string }) => void | Promise<void>;
  isLoading?: boolean;
}
...
export default function RemoveContentModal({
  ...
  const handleConfirm = async () => {
    if (onProceed) {
      await onProceed({ removalReason: reason });
    }
  };
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            {isConfirming ? "Are you sure?" : "Remove Content"}
          </h2>
          ...
          {isConfirming ? (
            ...
            <div className="flex flex-col gap-8 items-center justify-center py-8">
              <p className="text-base text-gray-300 text-center">
                Are you sure you want to remove this content? This action is
                irreversible.
              </p>
